...
currentState_Ego = State(150,0,0,6); % Initial state for the Ego Vehicle (which decides for the maneuvers)
currentStates_Other = [State(125,0,0,8) State(150,3.7000,0,2) State(165,0,0,8)]; % Initial state for the Other Vehicles
