...
prepare_simulation('s_0', [0, 60, 40], 'd_0', [0, 0, 3.7], ...
    'v_0', [20, 10, 13], 'v_ref', [20, 10, 13], 'planner', 'MANUAL');
run_simulation();
...
prepare_simulation('s_0', [0, 40, 20], 'd_0', [0, 0, 3.7], ...
    'v_0', [23.5, 10, 30], 'v_ref', [30, 10, 4.2], 'planner', 'MANUAL');
run_simulation();
...
prepare_simulation('s_0', [0, 9, 0], 'd_0', [0, 0, 3.7], ...
    'v_0', [15, 10, 30], 'v_ref', [15, 30, 0], 'planner', 'MANUAL');
run_simulation();
...
prepare_simulation('s_0', [0, 30, 55], 'd_0', [0, 0, 3.7], ...
    'v_0', [16.1, 10, 0.3], 'v_ref', [16.1, 10, 30], 'planner', 'MANUAL');
run_simulation();
